...
export const PlantQuickSheet = ({ plant, visible, onClose, onDetails, weatherRainExpected }: Props): React.JSX.Element | null => {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    editSaveBtnText: { color: theme.card, fontWeight: '700', fontSize: 13 },
    ...
    taskBtnOverdue: { backgroundColor: theme.dangerLight, borderColor: theme.dangerLight },
    ...
    taskBtnCheckText: { color: theme.card, fontSize: 16, fontWeight: '700' },
    ...
    showMoreText: { fontSize: 13, color: theme.primary, fontWeight: '600' },
    detailsBtn: {
      marginHorizontal: 16,
      marginTop: 12,
      backgroundColor: theme.primary,
    ...
    detailsBtnText: { fontSize: 14, color: theme.card, fontWeight: '600' },
    hintText: { textAlign: 'center', fontSize: 10, color: theme.textMuted, marginTop: 6, paddingBottom: 4 },
  }), [theme]);
