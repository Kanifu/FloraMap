...
// Premium column backgrounds stay hardcoded — brand identity
...
export function TierComparisonModal({ visible, onClose }: Props): React.JSX.Element {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    title:      { fontSize: 20, fontWeight: '700', color: theme.primaryDark, paddingHorizontal: 20, paddingVertical: 12, borderBottomWidth: 1, borderBottomColor: theme.primaryBg },
    ...
    currentBadgeText: { fontSize: 9, color: theme.card, fontWeight: '700' },
    scroll:     { paddingHorizontal: 12 },
    row:        { flexDirection: 'row', alignItems: 'center', paddingVertical: 9, borderBottomWidth: StyleSheet.hairlineWidth, borderBottomColor: theme.primaryBg },
    ...
    footer:     { padding: 16, borderTopWidth: 1, borderTopColor: theme.primaryBg },
    ...
    closeBtnText: { color: theme.card, fontWeight: '700', fontSize: 15 },
  }), [theme]);
