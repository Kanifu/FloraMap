...
export function StatsModal({ visible, onClose }: Props): React.JSX.Element {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    harvestRow:   { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', backgroundColor: theme.warningLight, borderRadius: 10, padding: 12, borderWidth: 1, borderColor: '#ffe08a' },
