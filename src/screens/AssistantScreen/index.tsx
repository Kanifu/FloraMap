...
const AssistantScreen = (): React.JSX.Element => {
  ...
  const styles = useMemo(() => StyleSheet.create({
    ...
    addButtonDone: { backgroundColor: theme.borderLight },
    ...
    tipCard: {
      backgroundColor: theme.primaryLight, borderRadius: 12, padding: 12, marginBottom: 12,
    },
    tipTitle: { fontWeight: '600', color: theme.primary, marginBottom: 4, fontSize: 14 },
    tipBody: { color: theme.primaryDark, lineHeight: 20, fontSize: 14 },
  }), [theme]);
