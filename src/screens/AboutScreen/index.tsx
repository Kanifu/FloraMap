...
const AboutScreen = (): React.JSX.Element => {
  ...
  const styles = StyleSheet.create({
    ...
    tierBadge: {
      ...
      backgroundColor: theme.warningLight, paddingHorizontal: 12, paddingVertical: 3, borderRadius: 20,
    },
    tierBadgePremium: { color: '#7c3aed', backgroundColor: '#ede9fe' },
    tierBadgePlus: { color: theme.warning, backgroundColor: theme.warningLight },
