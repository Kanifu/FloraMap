      ...
      <View style={styles.header}>
        ...
        <View style={styles.headerActions}>
          <TouchableOpacity
            ...
            accessibilityLabel="Exporteer naar agenda"
            accessibilityRole="button">
            <Text style={styles.headerIconText}>{exporting ? '⏳' : '📅'}</Text>
          </TouchableOpacity>
          <TouchableOpacity onPress={() => setShowFeedback(true)} style={styles.headerIconBtn} accessibilityLabel="Stuur een bugmelding" accessibilityRole="button">
