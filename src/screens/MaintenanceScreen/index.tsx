...
const TaskItem = ({ flatTask, onComplete, onNavigate, rainExpected, droughtDays }: TaskItemProps): React.JSX.Element => {
  ...
  const renderRightActions = () => (
    <TouchableOpacity style={styles.swipeComplete} onPress={handleComplete} activeOpacity={0.85} accessibilityLabel="Voltooien" accessibilityRole="button">
...
const MaintenanceScreen = (): React.JSX.Element => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <View style={styles.headerActions}>
          <TouchableOpacity
            ...
            accessibilityLabel="Exporteren naar kalender"
            accessibilityRole="button">
      ...
      {/* Stats tab moved to StatsModal in drawer */}
