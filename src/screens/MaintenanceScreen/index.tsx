    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.streakRow}>
        ...
        {earnedBadges.length > 0 ? (
          ...
          <Text style={{ fontSize: 11, color: theme.textMuted }}>🏆 Badges: —</Text>
        )}
      </View>
...
const makeStyles = (theme: ReturnType<typeof useTheme>) => StyleSheet.create({
  ...
  harvestCard: {
    backgroundColor: theme.warningLight, borderRadius: 12, borderWidth: 1, borderColor: '#ffe08a',
    padding: 14, gap: 6, marginBottom: 12,
  },
  ...
  // Zaaikalender tab
  zaaiSeizoenCard: {
    backgroundColor: theme.primaryLight, borderRadius: 12, borderWidth: 1, borderColor: '#74c69d',
  ...
  zaaiMonthCardCurrent: {
    borderColor: '#40916c', backgroundColor: theme.primaryBg,
  },
  zaaiMonthName: {
