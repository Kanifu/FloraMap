...
const SeedInventoryScreen = (): React.JSX.Element => {
  ...
  const renderItem = ({ item }: { item: SeedPacket }) => {
    ...
    const isExpiringSoon = item.expiryYear !== undefined && (
      ...
      (item.expiryYear === CURRENT_YEAR + 1 && CURRENT_MONTH >= 9)
    );
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <TouchableOpacity style={styles.addBtn} onPress={() => setShowModal(true)} accessibilityLabel="Zaadpakket toevoegen" accessibilityRole="button">
